            ...
            <div class="box1">
                <div class="leftbox1">
                    <ul class="leftmenu-ul">
                        <li class="leftmenu-li" style="background-color:#2b5ec1; font-size:17px; cursor: auto;"><strong>系统管理</strong></li>
    ...
    data(){
        return{
            ...
            xtItems:[
                ...
                { name:"系统设置",active:true,page:'/xtglRoom/' },
                { name:"修改密码",active:false,page:'/xtglPass/' },
                { name:"操作日记管理",active:false,page:'/xtglLog/' },
                { name:"示意图选择",active:false,page:'/xtglView/' },
                { name:"分站显示位置",active:false,page:'/xtglPosition/' },
                { name:"工作区显示位置",active:false,page:'/xtglWork/' },
                { name:"注销登录",active:false,page:'/xtglLogout/' }
            ]
        }
    },
    methods:{
        ...
        isActive(index){
            ...
            // 定义 跳转路径
            var goPath = "/about/xtgl"+this.xtItems[index].page;
            // 判断当前路径
