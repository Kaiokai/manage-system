            ...
            <div class="box1">
                <div class="leftbox1">
                    <ul class="leftmenu-ul">
                        <li class="leftmenu-li" style="background-color:#2b5ec1; font-size:17px; cursor: auto;"><strong>员工管理</strong></li>
    ...
    data(){
        return{
            ...
            xtItems:[
                ...
                { name:"员工查询",active:true,page:'/ygglWorker/' },
                { name:"新建员工信息",active:false,page:'/ygglCreate/' },
                { name:"修改员工信息",active:false,page:'/ygglChange/' },
                { name:"删除员工信息",active:false,page:'/ygglDel/' },
                { name:"标识卡管理",active:false,page:'/ygglCard/' }
            ]
        }
    },
    methods:{
        ...
        isActive(index){
            ...
            // 定义 跳转路径
            var goPath = "/about/yggl"+this.xtItems[index].page;
            // 判断当前路径
